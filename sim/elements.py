...
The fusion gate is now the classical Coulomb barrier from real Z, A
values (see sim/nuclear.py); the old can_fuse boolean has been removed.
"""
...
ELEMENTS: dict[str, Element] = {
    # symbol  name            Z    mass    rc    EN    val bnd  RGB                 de_rel  IE/eV
    'H':  Element('H',  'Hydrogen',    1,   1.008,  31, 2.20,  1,  1, (0.90, 0.90, 0.90), 1.0,  13.598),
    'D':  Element('D',  'Deuterium',   1,   2.014,  31, 2.20,  1,  1, (0.75, 0.75, 1.00), 1.0,  13.602),
    'He': Element('He', 'Helium',      2,   4.003,  28, 0.00,  2,  0, (0.85, 1.00, 1.00), 0.0,  24.587),
    'Li': Element('Li', 'Lithium',     3,   6.941, 128, 0.98,  1,  1, (0.80, 0.50, 1.00), 0.6,   5.392),
    'Be': Element('Be', 'Beryllium',   4,   9.012,  96, 1.57,  2,  2, (0.76, 1.00, 0.00), 0.7,   9.323),
    'B':  Element('B',  'Boron',       5,  10.811,  84, 2.04,  3,  3, (1.00, 0.71, 0.71), 0.8,   8.298),
    'C':  Element('C',  'Carbon',      6,  12.011,  77, 2.55,  4,  4, (0.50, 0.50, 0.50), 1.5,  11.260),
    'N':  Element('N',  'Nitrogen',    7,  14.007,  71, 3.04,  5,  3, (0.19, 0.31, 0.97), 1.3,  14.534),
    'O':  Element('O',  'Oxygen',      8,  15.999,  66, 3.44,  6,  2, (1.00, 0.13, 0.13), 1.2,  13.618),
    'F':  Element('F',  'Fluorine',    9,  18.998,  57, 3.98,  7,  1, (0.56, 0.82, 0.56), 1.4,  17.423),
    'Ne': Element('Ne', 'Neon',       10,  20.180,  58, 0.00,  8,  0, (0.70, 0.89, 0.96), 0.0,  21.565),
    'Na': Element('Na', 'Sodium',     11,  22.990, 166, 0.93,  1,  1, (0.67, 0.36, 0.95), 0.5,   5.139),
    'Mg': Element('Mg', 'Magnesium',  12,  24.305, 141, 1.31,  2,  2, (0.54, 1.00, 0.00), 0.7,   7.646),
    'Al': Element('Al', 'Aluminum',   13,  26.982, 121, 1.61,  3,  3, (0.75, 0.65, 0.65), 0.8,   5.986),
    'Si': Element('Si', 'Silicon',    14,  28.086, 111, 1.90,  4,  4, (0.94, 0.78, 0.63), 1.2,   8.152),
    'P':  Element('P',  'Phosphorus', 15,  30.974, 107, 2.19,  5,  3, (1.00, 0.50, 0.00), 1.0,  10.487),
    'S':  Element('S',  'Sulfur',     16,  32.060, 105, 2.58,  6,  2, (1.00, 1.00, 0.19), 1.1,  10.360),
    'Cl': Element('Cl', 'Chlorine',   17,  35.453, 102, 3.16,  7,  1, (0.12, 0.94, 0.12), 1.3,  12.968),
    'Ar': Element('Ar', 'Argon',      18,  39.948, 106, 0.00,  8,  0, (0.50, 0.82, 0.89), 0.0,  15.760),
    'K':  Element('K',  'Potassium',  19,  39.098, 203, 0.82,  1,  1, (0.56, 0.25, 0.83), 0.5,   4.341),
    'Ca': Element('Ca', 'Calcium',    20,  40.078, 176, 1.00,  2,  2, (0.24, 1.00, 0.00), 0.6,   6.113),
    'Ti': Element('Ti', 'Titanium',   22,  47.867, 136, 1.54,  4,  6, (0.75, 0.76, 0.78), 0.9,   6.828),
    'Fe': Element('Fe', 'Iron',       26,  55.845, 132, 1.83,  2,  6, (0.88, 0.40, 0.20), 1.1,   7.902),
    'Ni': Element('Ni', 'Nickel',     28,  58.693, 124, 1.91,  2,  6, (0.31, 0.82, 0.31), 1.0,   7.640),
}
